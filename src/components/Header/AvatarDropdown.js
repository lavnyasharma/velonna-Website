    ...
    <div className="AvatarDropdown ">
      <Popover className="relative">
        {({ open, close }) => (
          <>
            <Popover.Button
              className={` w-10 h-10 sm:w-10 sm:h-10 rounded-full text-slate-700 dark:text-slate-300 focus:outline-none flex items-center justify-center`}
            >
              <svg xmlns="http://www.w3.org/2000/svg" role="img" class="icon__account" aria-label="icon account" width="20" height="20" viewBox="0 0 24 23.77" fill="#27251F">
                <path d="M18.545 15.03A5.432 5.432 0 0124 20.485v3.273h-1.09v-3.273a4.345 4.345 0 00-4.365-4.364H5.455a4.345 4.345 0 00-4.364 4.364v3.273H0v-3.273a5.432 5.432 0 015.455-5.455zM12 0a6.518 6.518 0 016.545 6.545A6.518 6.518 0 0112 13.091a6.518 6.518 0 01-6.545-6.546A6.518 6.518 0 0112 0zm0 1.09a5.432 5.432 0 00-5.455 5.455A5.432 5.432 0 0012 12a5.432 5.432 0 005.455-5.455A5.432 5.432 0 0012 1.091z" fill="#27251F" />
              </svg>
